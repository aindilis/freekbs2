...
CREATE TABLE `arguments` (
  ...
  `Value` blob,
  PRIMARY KEY  (`ID`)
) ENGINE=MyISAM AUTO_INCREMENT=1305361 DEFAULT CHARSET=latin1;
...
CREATE TABLE `formulae` (
  ...
  PRIMARY KEY  (`ID`)
) ENGINE=MyISAM AUTO_INCREMENT=354464 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `metadata` (
  ...
  PRIMARY KEY  (`ID`)
) ENGINE=MyISAM AUTO_INCREMENT=35602 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2009-10-29  1:05:41
